...
if ($patches === []) {
    echo "No patches declared on this branch (forward-compat placeholder); nothing to verify.\n";
    exit(0);
}
...
{
    $pattern = '#^https://raw.githubusercontent.com/[Vv]ardot/drupal-patches/(?:refs/heads/)?patches/(.+)$#';
